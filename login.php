...
if(isset($_POST['btnlogin'])){
  ...
  $stm = "SELECT * FROM tbl_pos_user WHERE username='{$name}' AND password='{$pass}'";
	...
	<div class="login-page">
	  <div class="form">
	    ...
	    <form class="login-form" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
	      <input type="text" placeholder="username" name="txtname" autocomplete="off" autofocus="" value="" />
	      <input type="password" placeholder="password" name="txtpass" autocomplete="off" value="" />
