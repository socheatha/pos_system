...
<?php 
    ...
    if(isset($_POST["btn_add"])){
        ...
        $v_note = @$connect->real_escape_string($_POST["txt_note"]);
         ...
         $query_add = "INSERT INTO tbl_pos_wh_stock_out 
                              (whso_date_record
                                ,whso_letter_no
                                ,whso_product_code
                                ,whso_qty_out
                      ...
                      <div class="row">
                          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control" required  autocomplete="off" name="txt_qty_out" type="text" placeholder="qty out..">          
                              </div>
                              <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                               <div class="form-group">
                                ...
                                <input class="form-control" required  autocomplete="off" name="txt_sent_to" type="text" placeholder="received from..">          
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="note">Note:</label>
                                 <textarea class="form-control" rows="4"  autocomplete="off" id="note" name = "txt_note"></textarea>
                              </div>
                            </div>
                        </div>
                    </div>
