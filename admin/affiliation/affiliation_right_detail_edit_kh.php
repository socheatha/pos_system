...
// udate 
    if(isset($_POST['btn_update'])){
        ...
        $connect->query("UPDATE tbl_affiliation_right_aside SET 
            ars_title_kh='$v_title',
            ars_description_kh='$v_description',
    ...
    <div class="portlet-body">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Information in Khmer</h4>
            </div>
            <div class="modal-body">
                <form action="" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= $row->ars_title_kh ?>" name="txt_title" type="text" class="form-control" id="" placeholder="Input Title">
                    </div>
                
                    <div class="form-group">
                        <label for="">Description</label>
                        <textarea name="txt_description" class="form-control detail" id="detail" rows="4" placeholder="Input Description"><?= $row->ars_description_kh ?></textarea>
                    </div>
