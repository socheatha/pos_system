...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-image fa-fw"></i> Sell Stock Adjustment Administrator</h2>
        </div>
    </div>
    <br>
    <br>
                    ...
                    <?php 
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td>'.$row->code.'</td>';
                                echo '<td>'.$row->ref.'</td>';
                                echo '<td class="text-center">'.$row->sa_qty_add.'</td>';
                                echo '<td class="text-center">'.$row->sa_qty_minus.'</td>';
