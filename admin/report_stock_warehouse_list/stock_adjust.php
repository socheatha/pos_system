...
<?php 
  if(isset($_POST['search'])){
    ...
    $to = $_POST['to'];
    $v_date = date('Y-m-d');
    $sql = "SELECT * FROM tbl_pos_wh_stock_adjust AS A
    ...
    $sql = "SELECT * FROM tbl_pos_wh_stock_adjust AS A
                    LEFT JOIN tbl_pos_product AS B ON A.whsa_product_code=B.pro_id
                    LEFT JOIN tbl_pos_employee AS C ON A.whsa_employee=C.emp_id
                    WHERE A.whsa_date_record='$v_date'      ";  
    $result = $connect->query($sql);
  } 
?>
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-image fa-fw"></i> Report Warehouse Stock Adjust</h2>
        </div>
    </div>
    <br>
    <br>
            ...
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline " id="sample_2" role="grid" aria-describedby="sample_1_info">
              <thead>
                  <tr>
                      ...
                      <th>Product Code</th>
                      <th>Product Name</th>
                      <th class="text-center">Qty Add</th>
              ...
              <tbody>
                  ...
                  $total_minus=0;
                      ...
                      {     
                        $total_add+= $row["whsa_qty_add"]; 
                        $total_minus+= $row["whsa_qty_minus"]; 
                    ...
                    <tr>
                      ...
                      <td class="text-center"><?php echo number_format($v6a,0); ?></td>
                      <td><?php echo $v7;?></td>
                      <td><?php echo $v8;?></td>
                      <td><?php echo $v9;?></td>
                      <td><?php echo $v10;?></td>
              ...
              <tfoot>
                  <tr>
                      ...
                      <th class="text-center"> 
                          <?php
                              echo number_format($total_add,0);
                          ?>
                      </th>
                      <th class="text-center"> 
                          <?php
                              echo number_format($total_minus,0);
                          ?>
                      </th>
                      <th></th>
                      <th></th>
